...
class ManageHdmfSettings extends SettingsPage
{
    ...
    protected static string $settings = HdmfSettings::class;
    
    protected static ?string $navigationGroup = 'Mortgage';
    
    protected static ?int $navigationSort = 10;
    
    protected static ?string $title = 'HDMF (Pag-IBIG) Settings';
    
    protected static ?string $navigationLabel = 'HDMF Settings';
