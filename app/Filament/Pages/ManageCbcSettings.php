...
class ManageCbcSettings extends SettingsPage
{
    ...
    protected static string $settings = CbcSettings::class;
    
    protected static ?string $navigationGroup = 'Mortgage';
    
    protected static ?int $navigationSort = 12;
    
    protected static ?string $title = 'China Banking Corporation Settings';
    
    protected static ?string $navigationLabel = 'CBC Settings';
